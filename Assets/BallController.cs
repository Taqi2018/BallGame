...
public class BallController : MonoBehaviour
{
     ...
     public static event EventHandler<OnEnemyDieEventArgs> OnDieBall;
     public static event EventHandler OnBallThrow;

     public class OnEnemyDieEventArgs : EventArgs 
     {
          public Collision collisionPer;
     }
    ...
    Vector3 GetMouseWorldPosition()
     ...
     private void OnCollisionEnter(Collision collision)
     {
          if (collision.transform.tag == "Enemy")
          {
               ...
               {
                    OnDieBall?.Invoke(this, new OnEnemyDieEventArgs { collisionPer = collision});
